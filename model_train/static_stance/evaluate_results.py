...
def main():
    ...
    for model in models:
        ...
        path = list(pathlib.Path('output/gpfs/scratch/bsc88/bsc88080/static_stance/output/'+model+'/simple_splits').glob('St*/*.txt'))[0]
    ...
    for model in models:
        for topic in topics:
            ...
            path = list(pathlib.Path('output/gpfs/scratch/bsc88/bsc88080/static_stance/output/'+model+'/topic_splits/'+topic).glob('St*/*.txt'))[-1]
